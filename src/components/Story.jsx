...
export default function Story({img}){
    return(
        ...
        <section className="my-10 ">
            <h2 className="text-6xl text-center text-yellow-400 mb-8">My Inspiration</h2>
